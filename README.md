Proyecto para EL REGISTRO de CURSOS en una base de datos usando JAVA , JSP , patron de diseño MVC y JDBC para establecer nuestra conexion hacia la base de datos , 
